...
Examples:
  ...
  python _convert_examples.py

  # Convert all example notebooks back to scripts  
  python _convert_examples.py --to-script

  # Convert specific file to notebook
  python _convert_examples.py --file my_example.py

  # Convert specific notebook to script
  python _convert_examples.py --file my_example.ipynb --to-script
        """,
    )
