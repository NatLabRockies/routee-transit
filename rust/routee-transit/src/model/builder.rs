...
use crate::model::traversal::transit_speed_model::TransitSpeedModelBuilder;
...
pub const BUILDER_REGISTRATION: BuilderRegistration = BuilderRegistration(|builders| {
    ...
    builders.add_traversal_model(
        "transit_speed".to_string(),
        Rc::new(TransitSpeedModelBuilder {}) as Rc<dyn TraversalModelBuilder>,
    );
    Ok(())
});
